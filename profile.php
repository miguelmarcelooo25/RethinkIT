						...
						<?php while ($row = mysqli_fetch_assoc($result)):?>
							...
							<div style="background-color:white;display: flex;border:solid thin #aaa;border-radius: 10px;margin-bottom: 10px;margin-top: 10px;">
								<div style="flex:1;text-align: center;">
									<img src="<?=$user_row['image']?>" style="border-radius:50%;margin:10px;width:150px;height:150px;object-fit: cover;">
									<br>
								</div>
								<div style="flex:8">
									<?php if(file_exists($row['image'])):?>
										<div style="">
											<img src="<?=$row['image']?>" style="width:100%;height:250px;object-fit: cover;">
										</div>
									<?php endif;?>
									<div>
